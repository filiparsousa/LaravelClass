...
@section('content')
    ...
    <div class="row">
        <div class="col">
          <div class="card border-light mb-3 mx-auto shadow">
            <div class="card-header"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-book" viewBox="0 0 16 16">
        ...
        <div class="col">
          <div class="card border-light mb-3 mx-auto shadow">
            <div class="card-header"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
      ...
      <div class="row">
        <div class="col">
          <div class="card border-light mb-3 mx-auto shadow">
            <div class="card-header"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-aspect-ratio" viewBox="0 0 16 16">
        ...
        <div class="col">
          <div class="card border-light mb-3 mx-auto shadow">
            <div class="card-header"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-calendar-check" viewBox="0 0 16 16">
        ...
        <div class="col">
          <div class="card border-light mb-3 mx-auto shadow">
            <div class="card-header"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-video3" viewBox="0 0 16 16">
